...
namespace FCRM.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Register(RegisterOwnerViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new User { UserName = model.UserName, Name = model.UserName, Company = company };

                var result = UserManager.Create(user, model.Password);

                if (result.Succeeded)
                {
                    user.MyCompanies.Add(company);
